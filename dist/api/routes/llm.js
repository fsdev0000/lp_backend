...
exports.isAcousticLoopback = isAcousticLoopback;
exports.isGenuineUserSpeech = isGenuineUserSpeech;
exports.setupLlmWebSocket = setupLlmWebSocket;
const voiceMemory_1 = require("../../services/ai/voiceMemory");
 ...
 */
function isGenuineUserSpeech(userMessage, lastAssistantMessage, confidence) {
        ...
        ws.on('message', async (message) => {
            try {
                ...
                if (data.type === 'conversation_initiation_metadata') {
                    ...
                    RuntimeManager_1.runtimeManager.getOrCreateVoiceState(sessionId);
                    ...
                    RuntimeManager_1.runtimeManager.markAssistantSpeaking(sessionId, "Hi Test0012, ready when you are.");
                    ...
                    setTimeout(() => {
                        const current = RuntimeManager_1.runtimeManager.getVoiceState(sessionId);
                    ...
                    const voiceState = RuntimeManager_1.runtimeManager.getOrCreateVoiceState(sessionId);
                    ...
                    if (RuntimeManager_1.runtimeManager.isAssistantCurrentlySpeaking(sessionId, approxWords)) {
                    ...
                    RuntimeManager_1.runtimeManager.recordUserSpeech(sessionId); // Transitions to USER_SPEAKING, waitingForUser = false
                    ...
                    const currentState = RuntimeManager_1.runtimeManager.getVoiceState(sessionId)?.turnState || 'WAITING_FOR_USER';
