...
exports.getChatRulesPrompt = void 0;
const getChatRulesPrompt = () => `## CHAT INTERFACE PROTOCOL (JSON MODE)
...
- "cta": Set to true ONLY when you reach the booking stage and explicitly recommend scheduling a Strategic Review session with Lionel Eersteling, guiding the founder by saying: "The 'Show Available Times' button is now visible on your screen. Click it to open the calendar and choose your preferred time." For both Text and Voice, the button must remain strictly hidden until this explicit recommendation stage is reached. Once "cta" is true, remain in the persistent state WAITING_FOR_FOUNDER; do not terminate or close the discussion. Keep answering follow-up questions while leaving "cta": true so the button remains visible until the founder explicitly clicks to book or exit.`;
exports.getChatRulesPrompt = getChatRulesPrompt;
